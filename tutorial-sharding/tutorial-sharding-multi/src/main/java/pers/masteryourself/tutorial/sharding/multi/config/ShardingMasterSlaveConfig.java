 ...
 */
@Configuration
@PropertySource("classpath:application-sharding-multi-master-slave.properties")
@MapperScan(basePackages = {"pers.masteryourself.tutorial.sharding.multi.mapper.masterslave"}, sqlSessionFactoryRef = "masterSlaveDataSourceSqlSessionFactory")
public class ShardingMasterSlaveConfig {
    ...
    public SqlSessionTemplate masterSlaveDataSourceSqlSessionTemplate() throws Exception {
    ...
    @ConfigurationProperties(prefix = "spring.multi.master.datasource")
    ...
    @ConfigurationProperties(prefix = "spring.multi.master-slave0.datasource")
    ...
    @ConfigurationProperties(prefix = "spring.multi.master-slave1.datasource")
