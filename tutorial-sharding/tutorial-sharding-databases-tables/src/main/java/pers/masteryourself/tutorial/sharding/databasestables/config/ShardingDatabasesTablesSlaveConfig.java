package pers.masteryourself.tutorial.sharding.databasestables.config;
...
/**
 * <p>description : ShardingDatabasesTablesSlaveConfig
 * 分库分表, 共两库, 每库四张表
 *
...
@MapperScan(basePackages = {"pers.masteryourself.tutorial.sharding.databasestables.mapper"})
public class ShardingDatabasesTablesSlaveConfig {
